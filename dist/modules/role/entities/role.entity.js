...
let Roles = exports.Roles = class Roles extends typeorm_1.BaseEntity {
};
__decorate([
...
__decorate([
    ...
    __metadata("design:type", typeorm_1.Timestamp)
], Roles.prototype, "deleted_at", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => user_roles_entity_1.UserRoles, (UserRoles) => UserRoles.role_id),
